...
def modificar_productos():
    ...
    item = grilla.item(grilla.selection())['text'] # -- esto es lo mismo que lo de item y producto en eliminarProductos, pero en una sola linea
    stock_viejo = grilla.item(grilla.selection())['values'][0]
    ...
    Label(ventana_editar, text='Nombre Actual: ').grid(row=0,column=1)
    ...
    Label(ventana_editar, text='Nombre Nuevo: ').grid(row=1, column=1)
