...
#Crear una funcion que valide las credenciales del usuario, las cuales tiene las siguientes reglas: -Usuario tiene que tener minimo 6 letras -Contraseña mayor a 8 caracteres         -Si no se cumple con estas condiciones, informar al usuario
def a(usuario,contraseña):
    if len(usuario) < 6 or len(contraseña) < 8:
        return("Usuario o contraseña invalidos")
    else:
        return("Datos correctos")
usuario1 = a("tomas","1234567")
print(usuario1)
usuario2 = a("tomas12","123456789")
print(usuario2)
