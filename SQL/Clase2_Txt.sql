...
-- UPDATE Nombre_Tabla SET CampoActualizar = NuevoValor WHERE criterio de seleccion
UPDATE Productos set precio = 1500 where id_producto = 3

-- SELECT (Seleccionar o recuperar una lista de campos para verla)
-- SELECT Columna FROM Nombre_Tabla WHERE "criterio de seleccion"
...
-- IN (Para poner muchos valores en una operacion sola)
